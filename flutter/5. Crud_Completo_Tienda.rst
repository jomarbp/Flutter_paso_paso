...
8.  Para poder visualizar las imágenes dentro de los TextView en Flutter, deberá crear un nuevo fichero de nombre *.htaccess*, dentro de la carpeta raiz [C:\xampp\htdocs\tienda].
